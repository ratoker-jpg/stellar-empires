...
const SEEDS: readonly Seed[] = [
  ...
  { key: 'scrapyard', zoneId: 'industry', maxLevel: 10, cost: { metal: 1_100, crystal: 800, gas: 300 }, seconds: 420, requirements: (ids) => [requirement(ids.constructionComplex, 3), requirement(ids.hangar, 2)], economy: { energyConsumption: 18, populationUse: 2, stabilityDemand: 5 } },
  { key: 'tradeCenter', zoneId: 'industry', maxLevel: 10, cost: { metal: 1_400, crystal: 1_400, gas: 420 }, seconds: 480, requirements: (ids) => [requirement(ids.government, 2), requirement(ids.metalStorage, 2), requirement(ids.crystalStorage, 2), requirement(ids.gasStorage, 2)], economy: { energyConsumption: 20, populationUse: 2, stabilityCapacity: 8 } },
