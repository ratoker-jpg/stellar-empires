...
export {
  ...
  COMPLETE_COMMANDER_SHIP_CLASSES,
  getCompleteCommanderShipClass,
  getCompleteCommanderShipDefinition,
  getCompleteCommanderShipId,
  getCompleteCommanderShipIds,
} from './completeCommanderShipCatalog';
export {
