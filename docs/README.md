...
13. [`14-delivery-batches.md`](14-delivery-batches.md) — автономные циклы минимум из четырёх последовательных PR.
...
- полный asset pipeline делится на этапы `P0–P4`;
...
6. Собрать контрольный визуальный набор `P0`.
