...
| `ORDINARY-MISSIONS-INTELLIGENCE-01` | Medium | #116 · `3cdd4f106f163a57a564d8ac2b2ff3c38b5ebbe5` | #117 `MISSION-RULES-REGISTRY` · `669cca1510f242cb7069831420edd488af435d4d`; #118 `ESPIONAGE-COUNTERINTELLIGENCE` · `46570544da064f839055afd3c10a387326452811`; #119 `INTELLIGENCE-REPORTS-PRESENTATION` · `e297f77f8e994f37402090a8d9d7c70e28ce099f`; planned #120 `MISSION-INTELLIGENCE-BOT-GATE` | active; shared mission rules, deterministic scout/counter-intelligence, derived intelligence reports and redacted incoming-flight presentation delivered; schema v14, command set and mission enum unchanged | planned `docs/audits/completed/ordinary-missions-intelligence-01.md` |
