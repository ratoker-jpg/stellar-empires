...
| `PLANET-DEMOLITION-DESTRUCTION-01` | Heavy | #121 · `2000a68216c7681fcbea0d69d1ed7e58e0c0c7f9` | active #122 `PLANET-DEMOLITION-CONTRACT`; blocked #123 `PLANET-DESTRUCTION-RECOVERY-GATE` | implementation active; #122 owns deterministic building demolition only; full planet removal/recovery remains in #123; schema v14 retained | planned `docs/audits/completed/planet-demolition-destruction-01.md` |
