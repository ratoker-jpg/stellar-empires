...
| `COHERENT-UI-SHELL-01` | Medium | #111 · active Audit PR | planned #112–#115 | audit active; implementation not started; application controller, canonical shell route, static navigation registry and routed primary workspaces | planned `docs/audits/completed/coherent-ui-shell-01.md` |
