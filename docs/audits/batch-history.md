...
| `ORDINARY-MISSIONS-INTELLIGENCE-01` | Medium | #116 · accepted on merge of this PR | planned #117 `MISSION-RULES-REGISTRY`; #118 `ESPIONAGE-COUNTERINTELLIGENCE`; #119 `INTELLIGENCE-REPORTS-PRESENTATION`; #120 `MISSION-INTELLIGENCE-BOT-GATE` | audit accepted; shared mission rules, schema-v14 intelligence depth, redacted reports/UI and honest bot gate authorized; no new mission kind or schema change | planned `docs/audits/completed/ordinary-missions-intelligence-01.md` |
