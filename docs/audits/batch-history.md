...
| `PLANET-DEMOLITION-DESTRUCTION-01` | Heavy | #121 · `2000a68216c7681fcbea0d69d1ed7e58e0c0c7f9` | planned #122 `PLANET-DEMOLITION-CONTRACT`; planned #123 `PLANET-DESTRUCTION-RECOVERY-GATE` | audit accepted; ordinary attack demolition, safe planet removal including special-mission returns, released-position recovery and full gate; schema v14 retained | planned `docs/audits/completed/planet-demolition-destruction-01.md` |
