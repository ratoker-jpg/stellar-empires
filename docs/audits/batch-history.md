...
| `PLANET-DEMOLITION-DESTRUCTION-01` | Heavy | #121 · `2000a68216c7681fcbea0d69d1ed7e58e0c0c7f9` | #122 · `be0caff4fbf06384cdf5d370dbc2da80d4081152`; #123 · exact SHA recorded in GitHub merge metadata | completed; deterministic demolition, capped planet destruction, final-colony protection, atomic live-reference recovery, special-mission returns, released-coordinate debris/recolonization and Browser E2E; schema v14 retained; no divergence | `docs/audits/completed/planet-demolition-destruction-01.md` |
