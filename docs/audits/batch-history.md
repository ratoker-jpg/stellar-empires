...
| `COHERENT-UI-SHELL-01` | Medium | #111 · `d64aa6d55d1056132b075d8b36ae0beec79e689d` | #112 · recorded in GitHub merge metadata; planned #113–#115 | implementation in progress; #112 delivered application controller, Planet/Space shell routes, typed registry and Browser E2E; no schema or mechanics divergence | planned `docs/audits/completed/coherent-ui-shell-01.md` |
