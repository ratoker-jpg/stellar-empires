...
| `ORDINARY-MISSIONS-INTELLIGENCE-01` | Medium | #116 · `3cdd4f106f163a57a564d8ac2b2ff3c38b5ebbe5` | #117 `MISSION-RULES-REGISTRY` · `669cca1510f242cb7069831420edd488af435d4d`; planned #118 `ESPIONAGE-COUNTERINTELLIGENCE`; #119 `INTELLIGENCE-REPORTS-PRESENTATION`; #120 `MISSION-INTELLIGENCE-BOT-GATE` | active; shared ordinary mission rules, flight-slot enforcement, level-three attack intelligence and redacted Fleet targets delivered; schema v14 and mission enum unchanged | planned `docs/audits/completed/ordinary-missions-intelligence-01.md` |
