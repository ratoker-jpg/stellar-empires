...
| `PLANET-DEMOLITION-DESTRUCTION-01` | Heavy | #121 · accepted by Audit PR merge | planned #122 `PLANET-DEMOLITION-CONTRACT`; planned #123 `PLANET-DESTRUCTION-RECOVERY-GATE` | audit in progress; ordinary attack demolition, safe planet removal, released-position recovery and full gate; schema v14 retained | planned `docs/audits/completed/planet-demolition-destruction-01.md` |
