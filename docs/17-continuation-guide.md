...
**Status:** Accepted  
**Updated:** 2026-07-26  
**Baseline:** merged PR #92; active PR #93
...
#93 — complete 13-ship rosters — active
#94 — complete 9-defence rosters — next
#95 — Commander Ships and full-game validation — planned
```

PR #91 must never be treated as delivered or reused. PR #92 is its clean replacement.

## Delivered runtime through PR #92
...
- committed source catalog for 39 ordinary ships, 27 defences and 13 Commander Ships.

## Active PR #93 boundary

PR #93 delivers:

- 13 ordinary ships for each faction;
- complete service and combat role coverage;
- faction-aware abilities and class combat profiles;
- mission, bot production and asset-manifest integration;
- deterministic compatibility aliases for old ship IDs;
- focused catalog, mission, ability and asset tests.

PR #93 intentionally does not deliver:

- the final 9-defence catalogs;
- Commander Ships;
...
1. finish and merge PR #93 after lint, typecheck, full tests and build are green;
2. create PR #94 from fresh `main` for 9 planetary defences per faction;
3. create PR #95 from fresh `main` for 13 Commander Ships and deterministic full-game validation;
4. begin Universe navigation only after the complete catalog gate passes.
